...
- **SC-003**: Sunrise and sunset times agree with published reference values within the stated rise/set tolerance at every test location and date. Differences from the current release are expected — measured at 12–55 s in the tropics and up to 172 s at high latitude — and each such difference moves the reported time toward the published reference, never away from it.
