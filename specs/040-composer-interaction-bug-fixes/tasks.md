...
- [ ] T004 [US2] In `ChatComposer.tsx`, ensure the Send button (currently gated on `composerVisualState === 'typing'` alone) continues to render for `'typing'`, now alongside attach+mic rather than as the row's only content.
