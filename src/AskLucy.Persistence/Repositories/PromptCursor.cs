...
/// <summary>Opaque keyset-pagination cursor for <see cref="PromptRepository.SearchAsync"/> — encodes the last row's active sort-column value (ticks) and id (tiebreaker), mirroring <c>ConversationCursor</c>.</summary>
