...
/// <summary>Opaque keyset-pagination cursor for <see cref="WorkflowRepository"/>/<see cref="WorkflowExecutionRepository"/> listings — encodes the last row's sort-column value (ticks) and id (tiebreaker), mirroring <c>AgentCursor</c>.</summary>
internal static class WorkflowCursor
{
