...
/// <summary>Opaque keyset-pagination cursor for <see cref="McpServerRepository"/>/<see cref="McpAuditLogRepository"/> listings — encodes the last row's sort-column value (ticks) and id (tiebreaker), mirroring <c>AgentCursor</c>.</summary>
