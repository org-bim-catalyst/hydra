...
export function useConversationAudio({
  ...
  const runAssistantTurn = useCallback(
    ...
    [
      voiceState, onUserTranscript, buildMessages, synthesis, chatId, providerId, modelId,
      generationParameters, language, onAssistantTextDelta, onAssistantTurnComplete, analyzer, mode,
    ],
  )
