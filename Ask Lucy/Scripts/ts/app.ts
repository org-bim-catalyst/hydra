    ...
    private initUi() {
        ...
        $('#mute-agent').on('click', (event) => {
            ...
            if ($(event.currentTarget).find('.fas').hasClass('fa-volume-up')) {
                ...
                this.voiceRecognizer.agentCanSpeak = false;
    ...
    speak(options?: any) {
        ...
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                let content = this.decode(container.innerHTML);
